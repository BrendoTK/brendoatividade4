        ...
        http.authorizeHttpRequests(
                        customizer ->
                                customizer
                                        ...
                                        .requestMatchers("/consultas/edit/{id}").hasAnyRole("ADMIN")
                                        .requestMatchers("/consultas/remove/{id}").hasAnyRole("ADMIN")
                                        .requestMatchers("/medicos/form").hasAnyRole("ADMIN")
                                        .requestMatchers("/medicos/edit/{id}").hasAnyRole("ADMIN")
                                        .requestMatchers("/medicos/remove/{id}").hasAnyRole("ADMIN")
                                        .requestMatchers("/pacientes/form").hasAnyRole("ADMIN")
                                        .requestMatchers("/pacientes/edit/{id}").hasAnyRole("ADMIN")
                                        .requestMatchers("/pacientes/remove/{id}").hasAnyRole("ADMIN")
